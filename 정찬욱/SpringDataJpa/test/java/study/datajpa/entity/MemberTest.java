...
class MemberTest {
    ...
    public void JpaEventBaseEntity() throws Exception{
        ...
        System.out.println("findMember.updatedAt = " + findMember.getLasModifiedDate());
        System.out.println("findMember.createdBy = " + findMember.getCreatedBy());//지금 uuid로 해놨는데 실전에서는 세션으로 하면 됨.
